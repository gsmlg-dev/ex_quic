...
M3-E is not complete. No independent QUIC peer revision, packet capture or network
matrix result is claimed here. Retry/token handling, broader loss/reordering/
