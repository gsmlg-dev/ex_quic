...
terminate a connection rather than silently extend unsupported behavior. Streams/profiles,
...
(127 tests, seed 644084), and `git diff --check` exited 0. Focused lifecycle
tests (29 tests) also exited 0.
