...
| Abyss M5 dispatcher seam | Opt-in persistent dispatcher, monitored route registry, bounded writer, legacy UDP path preserved | `gsmlg-dev/abyss@0de0b8a`; Abyss format/compile/full test gate passes; ex_quic adapter and QUIC-through-Abyss network acceptance remain pending |
