...
| Large CRYPTO fragmentation and bounded recovery | `test/quic/handshake_scheduler_test.exs`, `test/quic/recovery_test.exs`; 144-test gate | local passed; independent sustained large-flight pressure pending |
